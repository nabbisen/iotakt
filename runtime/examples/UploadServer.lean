...
open IotaktRuntime.Server IotaktRuntime.Loop IotaktRuntime.Http IotaktRuntime.RequestBody IotaktRuntime.Native Iotakt.Model
...
def main : IO Unit := do
  IO.println "iotakt upload server (v0.9 — IotaktRuntime.Server handoff surface)"
