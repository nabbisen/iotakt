...
open Iotakt.Model Iotakt.Native
...
def main : IO Unit := do
  ...
  let rawEvt : ByteArray :=
    ...
    ⟨#[10, 0, 0, 0,   1, 0, 0, 0]⟩
  let evts := Epoll.parseEvents rawEvt
